 ...
 */
export declare function format(num: number | string, decimalPoints?: number, separator?: string): string;
/**
 ...
 */
export declare function reFormat(formattedNum: string, separator?: string): number;
/**
